...
import com.miido.analiizoOBRAS.util.Encryptor;
...
public class LoginActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    private void storeUsersStructureToDB(String usersStructure)throws Exception{
        ...
        sqlHelper.setQuery(constants.CREATE_USERS_DATA_TABLE_QUERY);
        sqlHelper.execQuery();
        //sqlHelper.setQuery("UPDATE security SET iSecurityStatus = 2");
        sqlHelper.setQuery(constants.UPDATE_USERS_DATA_QUERY);
        sqlHelper.execUpdate();
        //sqlHelper.setQuery("INSERT INTO security VALUES (null, [STRUCTURE], 1)".replace("[STRUCTURE]", "'" + usersStructure + "'"));
