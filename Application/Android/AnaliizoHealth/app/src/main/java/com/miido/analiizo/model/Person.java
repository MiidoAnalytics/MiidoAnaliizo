...
public class Person implements Parcelable {
     ...
     * @param birthday fecha de nacimiento
     */
    public Person(int position,long id,String typeId,
                  String firstname1, String firstname2,
                  String lastname1, String lastname2,
                  char gender, String bloodgroup, char RH, long birthday){
    ...
    /**
     * Obtiene el tipo de identificación de una person
     * @return un cadena de texto con el tipo de identificación
     */
    ...
    /**
     * Establece el tipo de identificación de una persona
     * @param typeId tipo de identificación de la persona representada en una cadena de texto.
     */
