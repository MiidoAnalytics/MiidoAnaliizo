...
import com.miido.analiizo.mcompose.MasterTools;
...
public class Master extends Activity implements LocationListener{
    ...
    private JSONObject getPollResponse()throws Exception{
        ...
        response.put("SATISFACTION", new JSONObject(buffer.toString()));
    ...
    private void launchQuitConfirmDialog(){
        AlertDialog d = com.miido.analiizo.util.Dialog.confirm(this, "Confirmación", "Este informe ya ha sido enviado.\n" +
                    ...
                    try {
                        ...
                        if (masterTools.wLocalFile(masterTools.cHomePrefix + "." + constants.home, 1)) {
                            ...
                            try {
                                ...
                                poll.put("SATISFACTION",new JSONObject(data.getStringExtra(Main.RESPONSE_EXTRA)));
                                ...
                                /*if(key != null && value !=null){
                                    poll.getJSONObject("SATISFACTION").put(key, value);
                                }*/
