...
class Roles {
    ...
    public function insert() {
        ...
        if ($this->role_id) /* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spUpdateRoles(?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spinsertroles(?,?,?,?,?,?);');
    ...
    public function insertMenuRol() {
        ...
        if ($this->role_id) /* Modifica */ {
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spPrecargarMenusRol(?,?,?,?,?,?);');
    ...
    public function delete($role_id) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spdeleteroles(?,?);');
        $consulta->bindParam(1, $this->role_id, PDO::PARAM_INT);
    ...
    public function deleteRelRolUser($role_id) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spdeleteRelRolUser(?,?);');
    ...
    public static function searchById($role_id) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedRolestxId(?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_INT);
        $consulta->execute();
    ...
    public static function getAllRoles() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedDRoles();');
        $consulta->execute();
    ...
    public static function MenusPadres() {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMenuPadreRol();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
    ...
    public static function MenusHijos($menu_idP) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMenuHijoRol(?);');
    ...
    public static function VerificarMenuxRol($role_id, $menu_idH) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spValidarMenuxRol(?,?);');
    ...
    public static function ActualizarMenuRol($menu_idH, $IstatusId, $role_id) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spactualizarmenuxrol(?,?,?,?,?);');
    ...
    public static function IngresarMenuRol($role_id, $menu_idH, $menu_idP, $IstatusId) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spInsertMenuRol(?,?,?,?,?,?,?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(2, $menu_idH, PDO::PARAM_STR);
    ...
    public static function getAllUsuariosRol() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spselecteduserrol();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function rolUserxId($idusuario) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spvalidaruserxrol(?);');
    ...
    public static function obtenerMenuIni($role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spPrimerMenuIngreso(?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
    ...
    public static function obtenerMenuIniHijo($menu_idH, $rolePermiso) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spPrimerMenuIngresoHijo(?,?);');
        $consulta->bindParam(1, $menu_idH, PDO::PARAM_STR);
    ...
    public static function buscarMenusPadres($role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMenuPadre(?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
    ...
    public static function buscarMenusHijos($parent, $role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMenuHijo(?,?);');
    ...
    public static function contarSubmenuActivo($parent, $role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spContarSubmenus(?,?);');
        $consulta->bindParam(1, $parent, PDO::PARAM_STR);
        $consulta->bindParam(2, $role_id, PDO::PARAM_STR);
        $consulta->execute();
        if (!$consulta) {
    ...
    public static function ObternerMenus() {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spselectedmenus();');
        $consulta->execute();
        if (!$consulta) {
            echo "\nPDO::errorInfo():\n";
            print_r($consulta->errorInfo());
    ...
    public static function ObternerMenusAsignadosRol($role_id,$menu_idH) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMenuAsignadoRol(?,?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(2, $menu_idH, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function insertUserRol($idusuario, $role_id, $IstatusId) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spinsertuserrol(?,?,?,?,?,?);');
        $consulta->bindParam(1, $idusuario, PDO::PARAM_STR);
        $consulta->bindParam(2, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(3, $strRegisteredUser, PDO::PARAM_STR);
    ...
    public static function updateUserRol($idusuario, $role_id, $IstatusId) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spupdateuserrol(?,?,?,?,?);');
        $consulta->bindParam(1, $idusuario, PDO::PARAM_STR);
        $consulta->bindParam(2, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(3, $strRegisteredUser, PDO::PARAM_STR);
        $consulta->bindParam(4, $IstatusId, PDO::PARAM_STR);
    ...
    public function deleteUserRol($idusuario) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedRolUser(?,?);');
    ...
    public static function getLastRolId() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spgetlastrolid();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
