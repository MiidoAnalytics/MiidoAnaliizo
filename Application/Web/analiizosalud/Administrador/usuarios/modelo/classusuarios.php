...
class Usuarios {
    ...
    public function insert() {
        ...
        if ($this->idusuarios)/* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spUpdateUsuarios(?,?,?,?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spinsertusuarios(?,?,?,?,?,?,?,?,?);');
    ...
    public function delete($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedUsuario(?,?);');
    ...
    public function deleteRelUsuarioProyecto($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedUsuarioProyecto(?,?);');
        $consulta->bindParam(1, $idusuarios, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public function resetPass($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spResetPassAdm(?,?);');
        $consulta->bindParam(1, $this->idusuarios, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public static function searchById($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedUsuariosxId(?);');
        $consulta->bindParam(1, $idusuarios, PDO::PARAM_INT);
        $consulta->execute();
    ...
    public static function getAllUsuarios() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spselectedusuarios();');
        $consulta->execute();
