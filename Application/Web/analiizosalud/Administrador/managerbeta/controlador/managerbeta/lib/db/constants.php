 ...
 */
	...
	##  TABLES RELATIONS  ##
	########################
	define('_TABLEUSER', 'analiizo_salud.usuarios');
	define('_TABLEPOLL', 'analiizo_salud.estructuraencuestas');
	define('_TABLEPROJECT', 'analiizo_salud.proyecto');
