       ...
       $conexion = new ConexionAnaliizoPostgres();
        ...
        if ($this->intIdOccupations) /* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spUpdateOccupations(?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spInsertOccupations(?,?,?,?,?,?);');
                ...
                /* $procedimiento = 'select * from analiizo_salud.spInsertDepartment('. $this->strCodeOccupation. $this->strNameOccupation . $strRegisteredUser . $dtFechaRegistro . ')';
...
//        $consulta->bindParam(':intIdPais', $this->intIdPais);
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedOccupations(?,?);');
        $consulta->bindParam(1, $this->intIdOccupations, PDO::PARAM_INT);
    ...
    public static function searchById($intIdOccupations) {
       $conexion = new ConexionAnaliizoPostgres();
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedOccupationxId(?);');
    ...
    public static function getAllOccupations() {
       $conexion = new ConexionAnaliizoPostgres();
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedOccupations();');
        $consulta->execute();
