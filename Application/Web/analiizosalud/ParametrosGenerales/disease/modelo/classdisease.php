...
class Disease {
    ...
    public function guardar() {
        ...
        if ($this->intIdDiseases) /* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spUpdateDisease(?,?,?,?,?,?,?);');
            ...
            try {
                ...
                $intIdclassification = null;
                $intIdComplement = null;
                $consulta = $conexion->prepare('select * from analiizo_salud.spInsertDisease(?,?,?,?,?,?,?,?);');
                ...
                /* $procedimiento = 'select * from analiizo_salud.spInsertDepartment('. $this->strCodDepartamento. $this->strNombreDepartamento . $strRegisteredUser . $dtFechaRegistro . ')';
    ...
    public function delete($intIdDiseases) {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedDisease(?,?);');
    ...
    public static function searchById($intIdDiseases) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedDiseasexId(?);');
    ...
    public static function getAll() {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedDisease();');
        $consulta->execute();
