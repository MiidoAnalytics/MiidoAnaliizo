...
class Pais {
    ...
    public function guardar() {
        ...
        if ($this->intIdPais) /* Modifica */ {
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spInsertCountry(?,?,?,?,?,?);');
    ...
    public function eliminar($intIdPais) {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedCountry(?,?);');
    ...
    public static function recuperarTodos() {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedCountry();');
        $consulta->execute();
