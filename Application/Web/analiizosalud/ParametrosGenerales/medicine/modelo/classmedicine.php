    ...
    public function guardar() {
        ...
        if ($this->intIdMedicines) /* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spUpdateMedicine(?,?,?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_salud.spInsertMedicine(?,?,?,?,?,?,?,?);');
                ...
                /* $procedimiento = 'select * from analiizo_salud.spInsertMedicine('. $this->strCodMedicine . $this->strMedicineName . $intClassification . $dtCreateDate . ')';
...
//        $consulta->bindParam(':intIdMedicines', $this->intIdMedicines);
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spDeletedMedicine(?,?);');
    ...
    public static function searchById($intIdMedicines) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMedicinexId(?);');
    ...
    public static function recuperarTodos() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_salud.spSelectedMedicine();');
        $consulta->execute();
