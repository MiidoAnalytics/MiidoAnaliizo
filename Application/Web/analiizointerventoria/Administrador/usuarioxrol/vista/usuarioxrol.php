        ...
        <?php include("../../../sitemedia/html/scriptencabezado.php"); ?>
         <script type="text/javascript">
            function eliminar(data){
                ...
                if (r == true) {
                    window.location.href = 'deleteuserrol.php?idusuarios='+document.getElementById('idint'+data).value;
                } else {
                    window.location = self.location;
                } 
            }
        </script>
        <title> Listar Usuarios por Rol</title>
    </head>
    ...
    <body onmousemove ="contador();" onkeydown="contador();" style="background-image: url('/analiizo/images/background_03.png');background-repeat: no-repeat; background-position: left bottom; background-size: 100% auto;">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Administración Usuarios y Roles</h1>
                    </div>                    
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <p> <a href="../controlador/guardaruserrol.php"> Asignar/Cambiar Rol a Usuario </a> </p>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            if (count($userrolAll) > 0): 
                                                $i = 1; 
                                                foreach ($userrolAll as $item): ?>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <form name="fDelUsrRol" action="javascript:eliminar(<?php echo $i; ?>)" method="GET"> 
                                                            ...
                                                            <!-- <a href="../controlador/deleteuserrol.php?idusuarios=<?php //echo $item['idusuarios'] ?>"> Eliminar </a> -->
                                                        </td> 
                                                    </tr>
                                                <?php 
                                                $i++;
