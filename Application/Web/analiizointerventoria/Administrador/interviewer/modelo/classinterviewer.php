...
class Interviewer 
{
    ...
    public function guardar() 
    {
        ...
        if ($this->intIdInterviewer) /* Modifica */ 
        {
            ...
            {            
                ...
                $consulta = $conexion->prepare('select * from analiizo_interventoria.spUpdateInterviewer(?,?,?,?,?,?,?,?);');
        ...
        else /* Inserta */ 
        {
            try 
            {
                ...
                $consulta = $conexion->prepare('select * from analiizo_interventoria.spInsertInterviewer(?,?,?,?,?,?,?,?,?);');
    ...
    public function delete()
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spDeletedInterviewer(?,?);');
        $consulta->bindParam(1, $this->intIdInterviewer, PDO::PARAM_INT);
    ...
    public function deleteRelTablet()
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spDeleteRelTablet(?,?);');
        $consulta->bindParam(1, $this->intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public function deleteRelLocation()
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spDeleteRelLocation(?,?);');
        $consulta->bindParam(1, $this->intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public static function tabletAsignada($intIdinterviewer) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");        
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedTabletAsignada(?);');
        $consulta->bindParam(1, $intIdinterviewer, PDO::PARAM_INT);
        $consulta->execute();
        $registro = $consulta->fetch();
        $conexion = null;
