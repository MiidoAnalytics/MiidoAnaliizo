	...
	class ajax extends sqlController {
		...
		*/
		protected function projectFinder() {
			...
			$this->prepare(array(
				...
				"conditions" => 'intidregistereduser = idusuarios and analiizo_interventoria.proyecto.intistatus not in (3)'
			));
			$result = $this->exceute();
			$c = 0;
			echo "[";
		...
		*/
		protected function pollFinder() {
			$this->prepare(array(
				"operation"  => _ACTIONPOLLG,
				"fields" 	 => _POLLINDX.", "._POLLCONT.", analiizo_interventoria.estructuraencuestas.dtcreatedate, "._POLLSTAT.", intregistereduser, strlogin",
