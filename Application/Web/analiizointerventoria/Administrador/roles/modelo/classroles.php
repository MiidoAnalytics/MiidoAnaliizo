...
class Roles {
    ...
    public function insert() {
        ...
        if ($this->role_id) /* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_interventoria.spUpdateRoles(?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_interventoria.spinsertroles(?,?,?,?,?,?);');
    ...
    public function insertMenuRol() {
        ...
        if ($this->role_id) /* Modifica */ {
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from analiizo_interventoria.spprecargarmenusrol(?,?,?,?,?,?);');
    ...
    public function delete($role_id) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spdeleteroles(?,?);');
        $consulta->bindParam(1, $this->role_id, PDO::PARAM_INT);
    ...
    public static function searchById($role_id) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedRolestxId(?);');
    ...
    public static function getAllRoles() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedDRoles();');
        $consulta->execute();
    ...
    public static function MenusPadres() {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedMenuPadreRol();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
    ...
    public static function MenusHijos($menu_idP) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedMenuHijoRol(?);');
    ...
    public static function VerificarMenuxRol($role_id, $menu_idH) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spValidarMenuxRol(?,?);');
    ...
    public static function ActualizarMenuRol($menu_idH, $IstatusId, $role_id) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spactualizarmenuxrol(?,?,?,?,?);');
    ...
    public static function IngresarMenuRol($role_id, $menu_idH, $menu_idP, $IstatusId) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spInsertMenuRol(?,?,?,?,?,?,?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(2, $menu_idH, PDO::PARAM_STR);
    ...
    public static function getAllUsuariosRol() {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spselecteduserrol();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function rolUserxId($idusuario) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spvalidaruserxrol(?);');
    ...
    public static function obtenerMenuIni($role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spPrimerMenuIngreso(?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
    ...
    //****************************************************************************
    public static function obtenerMenuIniHijo($menu_idH) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spPrimerMenuIngresoHijo(?);');
        $consulta->bindParam(1, $menu_idH, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
    ...
    public static function buscarMenusPadres($role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedMenuPadre(?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
    ...
    public static function buscarMenusHijos($parent, $role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedMenuHijo(?,?);');
    ...
    public static function contarSubmenuActivo($parent, $role_id) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spContarSubmenus(?,?);');
        $consulta->bindParam(1, $parent, PDO::PARAM_STR);
        $consulta->bindParam(2, $role_id, PDO::PARAM_STR);
        $consulta->execute();
        if (!$consulta) {
    ...
    public static function ObternerMenus() {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spselectedmenus();');
        $consulta->execute();
        if (!$consulta) {
            echo "\nPDO::errorInfo():\n";
            print_r($consulta->errorInfo());
    ...
    public static function ObternerMenusAsignadosRol($role_id,$menu_idH) {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedMenuAsignadoRol(?,?);');
        $consulta->bindParam(1, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(2, $menu_idH, PDO::PARAM_STR);
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function insertUserRol($idusuario, $role_id, $IstatusId) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spinsertuserrol(?,?,?,?,?,?);');
        $consulta->bindParam(1, $idusuario, PDO::PARAM_STR);
        $consulta->bindParam(2, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(3, $strRegisteredUser, PDO::PARAM_STR);
    ...
    public static function updateUserRol($idusuario, $role_id, $IstatusId) {
        ...
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spupdateuserrol(?,?,?,?,?);');
        $consulta->bindParam(1, $idusuario, PDO::PARAM_STR);
        $consulta->bindParam(2, $role_id, PDO::PARAM_STR);
        $consulta->bindParam(3, $strRegisteredUser, PDO::PARAM_STR);
        $consulta->bindParam(4, $IstatusId, PDO::PARAM_STR);
    ...
    //****************************************************************************
    //Funcion que coloca el registro en estado 3//
    //****************************************************************************
    public function deleteUserRol($idusuario) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spDeletedRolUser(?,?);');
