...
class LocationInterviewers {
    ...
    public function insert($intIdInterviewer, $strCodTown,$strCodDepartament) {
        ...
        try {
            ...
            $consulta = $conexion->prepare('select * from analiizo_interventoria.spInsertLocationInterviewers(?,?,?,?,?,?,?);');
            ...
            /* $procedimiento = 'select * from analiizo_interventoria.spInsertCountry('. $this->strIdTown . $this->strNombreidPais . $strRegisteredUser . $dtCreateDate . ')';
    ...
    public function updateInterviewerLocation($intIdInterviewers, $strIdTown, $strIdDepartament) {
        ...
        try {
            ...
            $consulta = $conexion->prepare('select * from analiizo_interventoria.spUpdateInterviewersxLocations(?,?,?,?,?,?,?);');
...
//        $consulta->bindParam(':intIdInterviewer', $this->intIdInterviewer);
    ...
    public static function searchUserWithLocation($intIdInterviewers) {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedUserWithLocationxId(?);');
    ...
    public static function getAll() {
        $conexion = new ConexionAnaliizoPostgres();
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedLocationInterviewers();');
        $consulta->execute();
