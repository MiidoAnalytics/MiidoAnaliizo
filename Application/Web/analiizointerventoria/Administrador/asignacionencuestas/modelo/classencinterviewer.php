...
class EncuestaInterviewer 
{
    ...
    public function guardarEncuesaInterviewer($Encuesta, $intIdInterviewer) 
    {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spInsertecncuestaInterviewer(?,?,?,?,?,?);');
    ...
    public function guardarProyectoInterviewer($Proyecto, $intIdInterviewer) 
    {
        ...
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spInsertproyectoInterviewer(?,?,?,?,?,?);');
    ...
    public function deleterelEstructura($intIdInterviewer, $Encuesta)
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spDeletedInterviewerEncuesta(?,?,?);');
    ...
    public function deleterelProyectoEncues($intIdInterviewer, $Proyecto)
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spDeletedInterviewerProyecto(?,?,?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
    ...
    public static function contarInterviewerEncuesta($intIdInterviewer) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spselectedContarrEncuestaInterviewer(?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
        $consulta->execute();
    ...
    public static function validarInterviewerEncuesta($intIdInterviewer, $Encuesta) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spselectedValidarEncuestaInterviewer(?,?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $Encuesta, PDO::PARAM_INT);
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function contarProyectoEncues($intIdInterviewer, $Proyecto) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spselectedcontarproyectoencuestador(?,?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $Proyecto, PDO::PARAM_INT);
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function ObtenerEncuestadores() 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spselectedinterviewers();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
    ...
    public static function ObternerEncuestasProyecto($Proyecto) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedEncuestaProyectos(?);');
    ...
    public static function ObtenerProyectos() 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedProyectos();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
    ...
    public static function getAllRegisters() 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from analiizo_interventoria.spSelectedEncuestaInter();');        
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
