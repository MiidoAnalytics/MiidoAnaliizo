    ...
    <head>
        ...
        <script type="text/javascript">
            function eliminar(data){
                ...
                if (r == true) {
                    window.location.href = 'eliminarinsumo.php?intidinsumo='+document.getElementById('idint'+data).value;
                } else {
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <p> <a href="../controlador/guardarinsumo.php"> Crear nuevo insumo </a> </p>
                                        ...
                                        <tbody>
                                            ...
                                            if (count($insumos) > 0):
                                                ...
                                                foreach ($insumos as $item):
                                                    ...
                                                    <tr class="odd gradeX">
                                                        <td><?php echo $item['intidinsumo']; ?></td>
                                                        <td><?php echo $item['strnombreinsumo']; ?></td>
                                                        <td><?php echo $item['strregistereduser']; ?></td>
                                                        <td><?php echo $item['dtcreatedate']; ?></td>
                                                        <td><?php echo $item['dtmodifieddate']; ?></td>
                                                        <td><a href="../controlador/guardarinsumo.php?insumo_id=<?php echo $item['intidinsumo'] ?>"> Editar </a></td>
                                                        <td>
                                                            <form name="fVerPre" action="javascript:eliminar(<?php echo $i; ?>)" method="GET"> 
                                                                <input type="hidden" id="idint<?php echo $i; ?>" value="<?php echo $item['insumo_id'] ?>">
                                                                <input type="submit" class="btn btn-success2" value="Eliminar" style="width:95%"/>     
                                                            </form>
                                                        </td> 
                                                        <!-- <td><a href="../controlador/eliminarinsumo.php?insumo_id=<?php //echo $item['intidinsumo'] ?>"> Eliminar </a></td>  -->
                                                    </tr>
                                                    <?php
                                                    $i++;
                                                endforeach;
