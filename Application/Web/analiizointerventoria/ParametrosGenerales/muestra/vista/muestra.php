    ...
    <head>
        ...
        <script type="text/javascript">
            function eliminar(data){
                ...
                if (r == true) {
                    window.location.href = 'eliminarmuestra.php?muestra_id='+document.getElementById('idint'+data).value;
                } else {
                    window.location = self.location;
                } 
            }
        </script>
        <title> Listar Muestras </title>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <p> <a href="../controlador/guardarmuestra.php"> Crear nuevo muestra </a> </p>
                                        ...
                                        <tbody>
                                            ...
                                            if (count($muestras) > 0):
                                                ...
                                                foreach ($muestras as $item):
                                                    ...
                                                    <tr class="odd gradeX">
                                                        <td><?php echo $item['intidmuestra']; ?></td>
                                                        <td><?php echo $item['strnombremuestra']; ?></td>
                                                        <td><?php echo $item['strregistereduser']; ?></td>
                                                        <td><?php echo $item['dtcreatedate']; ?></td>
                                                        <td><?php echo $item['dtmodifieddate']; ?></td>
                                                        <td><a href="../controlador/guardarmuestra.php?muestra_id=<?php echo $item['intidmuestra'] ?>"> Editar </a></td>
                                                        <td>
                                                            <form name="fVerPre" action="javascript:eliminar(<?php echo $i; ?>)" method="GET"> 
                                                                <input type="hidden" id="idint<?php echo $i; ?>" value="<?php echo $item['muestra_id'] ?>">
                                                                <input type="submit" class="btn btn-success2" value="Eliminar" style="width:95%"/>     
                                                            </form>
                                                        </td> 
                                                        <!-- <td><a href="../controlador/eliminarmuestra.php?muestra_id=<?php //echo $item['intidmuestra'] ?>"> Eliminar </a></td>  -->
                                                    </tr>
                                                    <?php
                                                    $i++;
                                                endforeach;
