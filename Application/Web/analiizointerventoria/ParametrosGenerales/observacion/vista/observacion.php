    ...
    <head>
        ...
        <script type="text/javascript">
            function eliminar(data){
                ...
                if (r == true) {
                    window.location.href = 'eliminarobservacion.php?observacion_id='+document.getElementById('idint'+data).value;
                } else {
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <p> <a href="../controlador/guardarobservacion.php"> Crear nuevo observacion </a> </p>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            if (count($observacions) > 0):
                                                $i = 1;
                                                foreach ($observacions as $item):
                                                    ?>

                                                    <tr class="odd gradeX">
                                                        <td><?php echo $item['intidobservacion']; ?></td>
                                                        <td><?php echo $item['strdescricpion']; ?></td>
                                                        <td><?php echo $item['strregistereduser']; ?></td>
                                                        <td><?php echo $item['dtcreatedate']; ?></td>
                                                        <td><?php echo $item['dtmodifieddate']; ?></td>
                                                        <td><a href="../controlador/guardarobservacion.php?observacion_id=<?php echo $item['intidobservacion'] ?>"> Editar </a></td>
                                                        <td>
                                                            <form name="fVerPre" action="javascript:eliminar(<?php echo $i; ?>)" method="GET"> 
                                                                <input type="hidden" id="idint<?php echo $i; ?>" value="<?php echo $item['intidobservacion'] ?>">
                                                ...
                                                ?>
                                                <p> No hay observacions para mostrar </p>
                                            <?php
                                            endif;
                                        }
                                        ?>
