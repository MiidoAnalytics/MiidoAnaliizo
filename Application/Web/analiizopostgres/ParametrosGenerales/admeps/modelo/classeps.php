...
class Eps {
    ...
    public function insert() {
        ...
        if ($this->intIdEps)/* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spUpdateEps(?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spInsertEps(?,?,?,?,?,?);');
    ...
    public function delete($intIdEps) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spdeletedeps(?,?);');
        $consulta->bindParam(1, $this->intIdEps, PDO::PARAM_INT);
    ...
    public static function searchById($intIdEps) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spselectedepsxid(?);');
    ...
    public static function getAllEps() {
        ...
        $consulta = $conexion->prepare('select * from administracion.spselectedeps();');
        $consulta->execute();
