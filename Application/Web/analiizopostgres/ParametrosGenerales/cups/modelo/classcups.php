    ...
    public function insert() {
        ...
        if ($this->intIdCup) /* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spUpdateCups(?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spInsertCups(?,?,?,?,?,?);');
...
//        $consulta->bindParam(':intIdPais', $this->intIdPais);
        ...
        $consulta = $conexion->prepare('select * from administracion.spDeletedCups(?,?);');
        $consulta->bindParam(1, $this->intIdCup, PDO::PARAM_INT);
    ...
    public static function searchById($intIdCup) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spSelectedCupstxId(?);');
    ...
    public static function getAllCups() {
        ...
        $consulta = $conexion->prepare('select * from administracion.spSelectedDCups();');
        $consulta->execute();
