...
class Proyectos {
       ...
       // echo $this->intidproyecto;
        if ($this->intidproyecto)/* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spUpdateProyectos(?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spinsertproyectos(?,?,?,?,?,?);');
                ...
                $consulta->execute();
                $this->intidproyecto = $conexion->lastInsertId();
    ...
    public function deleterelProyecto($intidproyecto) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spDeletedProyecto(?,?);');
