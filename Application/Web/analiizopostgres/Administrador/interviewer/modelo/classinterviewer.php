...
class Interviewer 
{
    ...
    public function guardar() 
    {
        ...
        if ($this->intIdInterviewer) /* Modifica */ 
        {
            ...
            {            
                ...
                $consulta = $conexion->prepare('select * from administracion.spUpdateInterviewer(?,?,?,?,?,?,?,?);');
        ...
        else /* Inserta */ 
        {
            try 
            {
                ...
                $consulta = $conexion->prepare('select * from administracion.spInsertInterviewer(?,?,?,?,?,?,?,?,?);');
    ...
    public function delete()
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from administracion.spDeletedInterviewer(?,?);');
        $consulta->bindParam(1, $this->intIdInterviewer, PDO::PARAM_INT);
    ...
    public function deleteRelTablet()
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from administracion.spDeleteRelTablet(?,?);');
        $consulta->bindParam(1, $this->intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public function deleteRelLocation()
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from administracion.spDeleteRelLocation(?,?);');
        $consulta->bindParam(1, $this->intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public static function buscarPorId($intIdinterviewer) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spSelectedInterviewerxId(?);');
    ...
    public static function tabletAsignada($intIdinterviewer) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");        
        $consulta = $conexion->prepare('select * from administracion.spSelectedTabletAsignada(?);');
        $consulta->bindParam(1, $intIdinterviewer, PDO::PARAM_INT);
        $consulta->execute();
        $registro = $consulta->fetch();
        $conexion = null;
    ...
    public static function buscarPorCod($intIdDepto) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spSelectedCountryxCod(?);');
