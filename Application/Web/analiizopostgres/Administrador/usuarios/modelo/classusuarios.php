...
class Usuarios {
    ...
    public function insert() {
        ...
        if ($this->idusuarios)/* Modifica */ {
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spUpdateUsuarios(?,?,?,?,?,?,?,?);');
            ...
            try {
                ...
                $consulta = $conexion->prepare('select * from administracion.spinsertusuarios(?,?,?,?,?,?,?,?,?);');
                ...
                /* $procedimiento = 'select * from administracion.spInsertDepartment('. $this->strFirstName. $this->strLastName . $strRegisteredUser . $dtFechaRegistro . ')';
    ...
    public function delete($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spDeletedUsuario(?,?);');
    ...
    public function deleteRelUsuarioProyecto($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spDeletedUsuarioProyecto(?,?);');
        $consulta->bindParam(1, $idusuarios, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public function resetPass($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spResetPassAdm(?,?);');
        $consulta->bindParam(1, $this->idusuarios, PDO::PARAM_INT);
        $consulta->bindParam(2, $dtModifiedDate, PDO::PARAM_STR);
        $consulta->execute();
        $conexion = null;
    ...
    public static function searchById($idusuarios) {
        ...
        $consulta = $conexion->prepare('select * from administracion.spSelectedUsuariosxId(?);');
        $consulta->bindParam(1, $idusuarios, PDO::PARAM_INT);
        $consulta->execute();
    ...
    public static function getAllUsuarios() {
        ...
        $consulta = $conexion->prepare('select * from administracion.spselectedusuarios();');
        $consulta->execute();
