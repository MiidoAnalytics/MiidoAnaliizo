...
class EncuestaInterviewer 
{
    ...
    public function guardarEncuesaInterviewer($Encuesta, $intIdInterviewer) 
    {
        ...
        $consulta = $conexion->prepare('select * from administracion.spInsertecncuestaInterviewer(?,?,?,?,?,?);');
    ...
    public function guardarProyectoInterviewer($Proyecto, $intIdInterviewer) 
    {
        ...
        $consulta = $conexion->prepare('select * from administracion.spInsertproyectoInterviewer(?,?,?,?,?,?);');
    ...
    public function deleterelEstructura($intIdInterviewer, $Encuesta)
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from administracion.spDeletedInterviewerEncuesta(?,?,?);');
    ...
    public function deleterelProyectoEncues($intIdInterviewer, $Proyecto)
    {
        ...
        $conexion->exec("set names utf8");
        $dtModifiedDate = date("Ymd");
        $consulta = $conexion->prepare('select * from administracion.spDeletedInterviewerProyecto(?,?,?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
    ...
    public static function contarInterviewerEncuesta($intIdInterviewer) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spselectedContarrEncuestaInterviewer(?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
        $consulta->execute();
    ...
    public static function validarInterviewerEncuesta($intIdInterviewer, $Encuesta) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spselectedValidarEncuestaInterviewer(?,?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $Encuesta, PDO::PARAM_INT);
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function contarProyectoEncues($intIdInterviewer, $Proyecto) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spselectedcontarproyectoencuestador(?,?);');
        $consulta->bindParam(1, $intIdInterviewer, PDO::PARAM_INT);
        $consulta->bindParam(2, $Proyecto, PDO::PARAM_INT);
        $consulta->execute();
        $registros = $consulta->fetchAll();
    ...
    public static function ObtenerEncuestadores() 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spselectedinterviewers();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
    ...
    public static function ObternerEncuestasProyecto($Proyecto) 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spSelectedEncuestaProyectos(?);');
    ...
    public static function ObtenerProyectos() 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spSelectedProyectos();');
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
    ...
    public static function getAllRegisters() 
    {
        $conexion = new ConexionAnaliizoPostgres();
        $conexion->exec("set names utf8");
        $consulta = $conexion->prepare('select * from administracion.spSelectedEncuestaInter();');        
        $consulta->execute();
        $registros = $consulta->fetchAll();
        $conexion = null;
        return $registros;
